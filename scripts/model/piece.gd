...
var move_directions:Array[PieceMovement.Pattern]
var take_directions:Array[PieceMovement.Pattern]
var modifiers:Array[PieceModifier]

func _init(_name, _color:PieceColor, _point_value:int, _move_directions:Array[PieceMovement.Pattern], _take_directions:Array[PieceMovement.Pattern], _modifiers:Array[PieceModifier] = []):
	name = _name
	color = _color
